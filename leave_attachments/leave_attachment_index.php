...
<head>
    <meta charset="UTF-8">
    <title>Leave Attachment Management</title>
    <style>
...
<body>
<div class="container">
    <h1>Leave Application Attachments</h1>
    ...
    <div class="card">
        ...
        <form id="uploadForm" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <select id="new_application_id" name="application_id" required>
                    <option value="">Select Application</option>
                    <?php
                    $result = $conn->query("SELECT application_id FROM leave_applications");
                    while ($row = $result->fetch_assoc()):
                        echo "<option value='{$row['application_id']}'>Application #{$row['application_id']}</option>";
                    endwhile;
                    ?>
                </select>
            </div>
            ...
            <div class="form-group">
                <label for="new_uploaded_by">Uploaded By</label>
                <select id="new_uploaded_by" name="uploaded_by" required>
            ...
            <button type="submit" class="success">📎 Upload Attachment</button>
        </form>
    </div>
    ...
    <div class="card">
        ...
        <table>
            ...
            <tbody>
                <?php
                $sql = "SELECT a.id, a.application_id, a.file_name, a.file_type, a.file_size, u.username
                ...
                <tr id="row_<?= $row['id'] ?>">
                    ...
                    <td>
                        <div class="action-buttons">
                            <button onclick="deleteAttachment(<?= $row['id'] ?>)" class="danger">🗑️ Delete</button>
                        </div>
                    </td>
                </tr>
                <?php endwhile; ?>
...
<script>
    ...
    document.getElementById('uploadForm').addEventListener('submit', function (e) {
        ...
        fetch('upload_leave_attachment.php', {
            method: 'POST',
            body: formData
        })
        ...
        .catch(error => {
            showNotification(`❌ Error uploading file: ${error}`, false);
    ...
    function deleteAttachment(id) {
        ...
        fetch('delete_leave_attachment.php', {
            method: 'POST',
